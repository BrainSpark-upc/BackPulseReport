package com.brainspark.pulsereport.platform.auditlogs.domain.model.queries;

import com.brainspark.pulsereport.platform.auditlogs.domain.exceptions.InvalidAuditLogException;
