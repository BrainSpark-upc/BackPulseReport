package com.brainspark.pulsereport.platform.clinicalevents.interfaces.rest;

import com.brainspark.pulsereport.platform.clinicalevents.application.commandservices.ClinicalEventCommandService;
import com.brainspark.pulsereport.platform.clinicalevents.application.queryservices.ClinicalEventQueryService;
import com.brainspark.pulsereport.platform.clinicalevents.domain.model.queries.GetAllClinicalEventsQuery;
import com.brainspark.pulsereport.platform.clinicalevents.domain.model.queries.GetClinicalEventsByPatientIdQuery;
import com.brainspark.pulsereport.platform.clinicalevents.interfaces.rest.resources.ClinicalEventResource;
import com.brainspark.pulsereport.platform.clinicalevents.interfaces.rest.resources.CreateClinicalEventResource;
import com.brainspark.pulsereport.platform.clinicalevents.interfaces.rest.transform.ClinicalEventResourceFromEntityAssembler;
import com.brainspark.pulsereport.platform.clinicalevents.interfaces.rest.transform.CreateClinicalEventCommandFromResourceAssembler;
