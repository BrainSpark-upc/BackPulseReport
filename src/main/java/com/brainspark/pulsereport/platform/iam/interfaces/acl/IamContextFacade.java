package com.brainspark.pulsereport.platform.iam.interfaces.acl;
...
public class IamContextFacade {
    ...
    public Long createUser(String username, String password) {
        ...
        if (result instanceof com.brainspark.pulsereport.platform.shared.application.result.Result.Success(var user)) {
            return user.getId();
        }
        return 0L;
    }
